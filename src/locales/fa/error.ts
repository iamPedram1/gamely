const errosTranslations = {
  ...
  ban: {
    unban: 'رفع مسدودیت',
    ban_self: 'نمیتوانید خودتان را مسدود کنید',
    ban_superAdmin: 'نمیتوانید مدیر کل را مسدود کنید',
    ban_admin: 'نمیتوانید مدیر را مسدود کنید',
    unban_admin: 'نمیتوانید مدیر را رفع مسدودیت کنید',
    unban_self: 'نمیتوانید خودتان را رفع مسدودیت کنید',
    not_banned: 'این کاربر در حال حاضر مسدود نیست',
    already_banned: 'این کاربر در حال حاضر مسدود است',
    have_been_baned_by_admin: 'شما توسط ادمین مسدود شده اید',
  },
  comment: {
  ...
  validation: {
    ...
    isMinDateNow: '{{property}} باید بعد از تاریخ/ساعت حال باشد',
    isMaxDateNow: '{{property}} باید قبل از تاریخ/ساعت حال باشد',
    isDateAfter: '{{property}} نمیتواند قبل از {{keyName}} باشد',
    isDateBefore: '{{property}} نمیتواند بعد از {{keyName}} باشد',
