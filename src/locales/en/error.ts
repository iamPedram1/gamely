const errosTranslations = {
  ...
  ban: {
    ...
    ban_admin: 'You cannot ban admin',
    ban_superAdmin: 'You cannot ban superAdmin',
    unban_self: 'You cannot unban yourself',
    unban_admin: 'You cannot unban admin',
  ...
  validation: {
    ...
    isMinDateNow: '{{property}} must be after current date/time',
    isMaxDateNow: '{{property}} must be before current date/time',
    isDateAfter: '{{property}} must be after {{keyName}}',
    isDateBefore: '{{property}} must be before {{keyName}}',
