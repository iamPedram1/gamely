const messageTranslations = {
  ...
  auth: {
    ...
    no_active_code: 'No active code found for this email',
    expired_code: 'This activation code is expired. request new one',
    invalid_code: 'Invalid verification code',
    password_recovery_emailSubject: 'Gamely - Password Recovery',
    verify_account_emailSubject: 'GameLy - Account Activation',
    ...
    not_verified: 'This account is not verified yet by user',
    login_success: 'Successfully logged in to account',
    logout_success: 'Successfully logged out',
    register_success: 'Account created successfully',
    account_verification_success: 'Account verification completed successfully',
  },
